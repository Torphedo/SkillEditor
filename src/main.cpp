...
//     {
//         std::cout << "Invalid Phantom Dust folder.\n";
//         return 1; // Failure
//     }
// 
//     GSDataStream.open(gsdatapath, std::ios::in | std::ios::binary); // Open file
...
//         return 1; // Failure
//     }
//     ofstream GSDataOut(gsdatapath, std::ios::binary); // Creates a new ofstream variable, using
//                                                  // the name of the file that was opened.
// 
